          ...
          return /* html */ `
              ...
              <div class="p-5">
                ...
                <div class="flex flex-col xl:flex-row justify-between">
                  <a id="addToCart" class="bg-gradient-to-r from-red-600 to-pink-500 rounded-full py-2 px-4 my-2 text-sm text-white hover:bg-pink-600 hover:from-pink-600 hover:to-pink-600 flex flex-row justify-center cursor-pointer" >
