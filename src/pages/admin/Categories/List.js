...
import { getAllCate,deleteCateByID } from "../../../api/Cate";
            ...
            .map((item) => {
               ...
               <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                     ...
                     <a href="/admin/cate/${item.id}/edit"><img class="h-10 w-10 rounded-full" src="${item.image}" alt=""></a>
                     </div>
                     <div class="ml-4">
        ...
        <header class="bg-white shadow">
         <div class="max-w-7x px-4 sm:px-6 lg:px-8 pb-6">
            ...
            <div class="flex-1 min-w-0">
               <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Danh Sách Categories</h2>
            </div>
