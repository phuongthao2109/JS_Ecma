...
const BannerEdit = {
    ...
    async before_render({ id }) {
        console.log(id);
        const CateEdit = await getBannerByID(id);
        this.state.data = CateEdit;
      ...
      <header class="bg-white shadow">
         <div class="max-w-7x px-4 sm:px-6 lg:px-8 pb-6">
            ...
            <div class="flex-1 min-w-0">
               <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Thêm Mới Bài Banner</h2>
            </div>
              ...
              <form class="pb-10" id="formEdit">
                  <div class="border overflow-hidden sm:rounded-md">
                      ...
                      <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                          <button type="button" id="btnSave" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                              Save
                          </button>
                      </div>
                  </div>
    ...
    after_render() {
        ...
        const postImage = document.querySelector("#image_cate");
        ...
        buttonSave.onclick = async function (e) {
            ...
            if (file) {
                ...
                imgurl = formEdit.oldImage.value
            }
            let params = {
