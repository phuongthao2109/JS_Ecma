...
import {createBrands} from "../../../api/Brand"
import axios from "axios";

const BrandsAdd = {

   before_render() {setTitle("Add Brands Page")},
   render() {
      return /* html */ `
         ...
         <div class="max-w-7x px-4 sm:px-6 lg:px-8 pb-6">
            ...
            <div class="flex-1 min-w-0">
               <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Thêm Mới Brand</h2>
            </div>
            <div class="mt-5 flex lg:mt-0 lg:ml-4">
               <a href="/admin/brands" class="sm:ml-3">
      ...
      <div class="mt-6">
         <div class="mt-5 md:mt-0">
            <form class="pb-10" id="formAddBrand">
   ...
   after_render(){
      const formAddBrand = document.querySelector("#formAddBrand");
      ...
      buttonSave.onclick = function () {
          ...
          axios.post(CLOUDINARY_API, formData, {
              ...
              let params = {
                  name: formAddBrand.name.value,
                  image: res.data.url,
              };
              
              createBrands(params).then(res => {
                  formAddBrand.reset();
