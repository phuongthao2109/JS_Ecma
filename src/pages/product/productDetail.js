...
const ProductDetails = {
    ...
    render() {
        ...
        <div class="pt-6">
            ...
            <ol role="list" class="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 lg:max-w-7xl lg:px-8">
              <li>
                <div class="flex items-center">
                  <a href="/product" class="mr-2 text-sm font-medium text-gray-900"> Products </a>
          ...
          <!-- Image gallery -->
          <div class="mt-6 max-w-l mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
            <div class="hidden aspect-w-3 aspect-h-4 rounded-lg overflow-hidden lg:block">
              <img src="${data.image}" alt="Two each of gray, white, and black shirts laying flat." class="w-full h-full object-center object-cover">
            </div>
            <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
              <div class="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                <img src="${data.image}" alt="Model wearing plain black basic tee." class="w-full h-full object-center object-cover">
              </div>
              <div class="aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                <img src="${data.image}" alt="Model wearing plain gray basic tee." class="w-full h-full object-center object-cover">
              </div>
            </div>
            <div class="aspect-w-4 aspect-h-5 sm:rounded-lg sm:overflow-hidden lg:aspect-w-3 lg:aspect-h-4">
              <img src="${data.image}" alt="Model wearing plain white basic tee." class="w-full h-full object-center object-cover">
            </div>
          </div>
                  ...
                  <fieldset class="mt-4">
                    ...
                    <div class="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                      ...
                      <label class="group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6 bg-white shadow-sm text-gray-900 cursor-pointer">
                        ...
                        <p id="size-choice-2-label">${data.size[0]}</p>
            ...
            <div class="py-10 lg:pt-6 lg:pb-16 lg:col-start-1 lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
              ...
              <div class="mt-10">
                ...
                <div class="mt-4 space-y-6">
                  <p class="text-sm text-gray-600">${data.short_description}</p>
                </div>
              </div>
            </div>
          </div>
