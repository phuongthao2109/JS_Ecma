...
const resultSearch = {
   render(){
      ...
      <a href="/product/">
        <img src="" class="rounded-tl-lg rounded-tr-lg" />
      </a>
      <div class="p-5">
        <h3><a href="/product/" class="product_name"></a></h3>
        ...
        <div class="flex flex-col xl:flex-row justify-between">
          ...
          <a class="bg-purple-600 rounded-full py-2 px-4 my-2 text-sm text-white hover:bg-purple-700 flex flex-row justify-center" href="/product/">
